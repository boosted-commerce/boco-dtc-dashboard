...
function MetricCard({
  ...
  const sevenDayBaseline =
    kind === 'count' || kind === 'currency' ? bucket.sevenDayTotal / 7 : bucket.sevenDayTotal;
...
export default async function Home({
  ...
  // failure (no API key, rate limit, parse error) → story card falls
  // back to the existing placeholder text.
        ...
        <section className="mb-6 rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
          ...
          {narrative ? (
            ...
            <p className="text-zinc-600 dark:text-zinc-400">
              ...
              the Anthropic API key is configured in Vercel
